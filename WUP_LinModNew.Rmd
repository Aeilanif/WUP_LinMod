...
According to the scatter plot , it appears to be that this is a strong positive linear correlation between the two numerical variables.I would say that there can be a 
